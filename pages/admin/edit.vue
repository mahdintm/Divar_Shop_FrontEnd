    ...
    <div class="SubmitAdvertisingContentBox">
      ...
      <div class="UploadAdvertisingImagesBox">
        ...
        <div class="UploadAdvertisingImagesSubBox">
          ...
          <div class="UploadImagesBox">
            ...
            <div
              class="ImageBox"
              v-for="Image in ImageInsertInWeb"
              :key="Image"
            >
              <img :src="Image" alt="" />
            </div>
            <div
              class="AddPathImageButton"
              @click="InsertImageButtonClicked"
              v-if="ImageInsertInWeb.length < 5"
            >
              <svg
                width="35"
                height="34"
      ...
      <div class="InformationAdvertisingBox">
        ...
        <div class="InformationAdvertisingSubBox">
          <div
            class="InformationInsertDataBox"
            v-for="(CategoryInEditMenu, index) in adsData.options"
            :key="index"
            v-if="index != 0"
          >
            <input
              class=""
              v-model="CategoryInEditMenu.key"
              type="text"
              name=""
              id=""
              placeholder="عنوان"
            ...
            <input
              type="text"
              v-model="CategoryInEditMenu.value"
              name=""
              id=""
              placeholder="توضیحات "
            />
        ...
        <div
          ...
          style="background-color: #a7211b; color: white"
          @click="SubmitAdvertising"
        >
      ...
      if (this.adsData.options[0]&&this.adsData.category_id&&this.adsData.code&&this.adsData.description&&this.adsData.price&&this.adsData.title) {
        ...
        await fetch(`http://${process.env.server_cdn_URL}/upload`, {
          ...
          this.adsData.imgs.push(
            `http://${process.env.server_cdn_URL}/upload/${a.name}`
          )
        })
      }
