      ...
      <div class="D_ContentHeader">
        ...
        <div class="D_IconsHeader">
          ...
          <lord-icon src="https://cdn.lordicon.com/dycatgju.json" trigger="hover" id="SettingIcon" class="SettingIcon"
            colors="primary:#707070" style="width: 24px; height: 24px">
          </lord-icon>
          <!-- Stop Setting Icon Codes -->

          <!-- Start Cart Icon Codes -->
          <lord-icon src="https://cdn.lordicon.com/lqsduwhb.json" trigger="hover" id="CartIcon" class="CartIcon"
            colors="primary:#707070" style="width: 24px; height: 24px">
          </lord-icon>
          <!-- Stop Cart Icon Codes -->

          <!-- Start Notification Icon Codes -->
          <lord-icon src="https://cdn.lordicon.com/msetysan.json" trigger="hover" id="NotificationIcon"
            class="NotificationIcon ActiveMarkIcon" colors="primary:#707070" style="width: 24px; height: 24px">
          </lord-icon>
          <!-- Stop Notification Icon Codes -->

          <!-- Start Help Icon Codes -->
          <lord-icon src="https://cdn.lordicon.com/gmgkjaqp.json" trigger="hover" id="HelpIcon" class="HelpIcon"
            colors="primary:#707070" state="hover-1" style="width: 24px; height: 24px">
          </lord-icon>
    ...
    <div class="D_ProfileModalSubBox" id="D_ProfileModal">
      <div class="ClientInformationBox">
        ...
        <div class="ClientUsernameInformation">
          <span>{{ myuser.firstname || myuser.lastname ? myuser.firstname && myuser.lastname ? `${myuser.firstname}
                      ${myuser.lastname}` : myuser.firstname ? myuser.firstname : myuser.lastname : myuser.email
          }}</span>
          <div v-if="myuser.acl == 1" class="ClientPermissionBox"><span>مدیر</span></div>
        </div>
      </div>
      <div class="ChangeClientInfoBox">
        ...
        <label for="ProfileModalEmailInput">
          <span>ایمیل</span>
          <input type="text" id="ProfileModalEmailInput" @blur="FocusOutInput" :value="myuser.email" disabled>
          <div class="EditIconBox" @click="OpenInputForEditing">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
                d="M16.5 15.6667C16.9603 15.6667 17.3334 16.0398 17.3334 16.5C17.3334 16.9602 16.9603 17.3333 16.5 17.3333H1.50002C1.03978 17.3333 0.666687 16.9602 0.666687 16.5C0.666687 16.0398 1.03978 15.6667 1.50002 15.6667H16.5ZM4.2441 10.0774L13.4108 0.910744C13.7112 0.610341 14.1839 0.587233 14.5108 0.841421L14.5893 0.910744L17.0893 3.41074C17.3897 3.71115 17.4128 4.18384 17.1586 4.51075L17.0893 4.58926L7.92261 13.7559C7.79238 13.8862 7.62348 13.9688 7.44289 13.9928L7.33335 14H4.83335C4.40599 14 4.05376 13.6783 4.00563 13.2639L4.00002 13.1667V10.6667C4.00002 10.4825 4.06099 10.3046 4.17175 10.16L4.2441 10.0774L13.4108 0.910744L4.2441 10.0774ZM14 2.67851L5.66669 11.0118V12.3333H6.98818L15.3215 4L14 2.67851Z"
