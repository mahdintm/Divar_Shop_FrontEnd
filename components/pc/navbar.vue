    ...
    <div class="D_Header" >
        <div class="D_RightHeader">
          ...
          <label for="SearchBarInput">
            <div class="D_SearchBarHeader">
              <lord-icon src="https://cdn.lordicon.com/rlizirgt.json" trigger="hover" colors="primary:#707070" style="width: 24px; height: 24px"> </lord-icon>
        ...
        <div class="D_LeftHeader">
          <div class="D_ContentHeader">
            <div class="D_AvatarHeader">
              <img src="@/static/img/avatar.png" alt="" />
            </div>
            <div class="D_IconsHeader">
              <!-- Start Setting Icon Codes -->
              <lord-icon @click="$nuxt.$emit('logout')"  src="https://cdn.lordicon.com/dycatgju.json" trigger="hover" id="SettingIcon" class="SettingIcon" colors="primary:#707070" style="width: 24px; height: 24px"> </lord-icon>
              <!-- Stop Setting Icon Codes -->

              <!-- Start Cart Icon Codes -->
              <lord-icon src="https://cdn.lordicon.com/lqsduwhb.json" trigger="hover" id="CartIcon" class="CartIcon" colors="primary:#707070" style="width: 24px; height: 24px"> </lord-icon>
              <!-- Stop Cart Icon Codes -->

              <!-- Start Notification Icon Codes -->
              <lord-icon src="https://cdn.lordicon.com/msetysan.json" trigger="hover" id="NotificationIcon" class="NotificationIcon ActiveMarkIcon" colors="primary:#707070" style="width: 24px; height: 24px"> </lord-icon>
              <!-- Stop Notification Icon Codes -->

              <!-- Start Help Icon Codes -->
              <lord-icon src="https://cdn.lordicon.com/gmgkjaqp.json" trigger="hover" id="HelpIcon" class="HelpIcon" colors="primary:#707070" state="hover-1" style="width: 24px; height: 24px"> </lord-icon>
...
export default {
    ...
    mounted() {
        document.getElementById("SettingIcon").addEventListener("mouseenter", () => {
                  document.getElementById("SettingIcon").colors = "primary:#252525";
                });
                document.getElementById("SettingIcon").addEventListener("mouseleave", () => {
                ...
                document.getElementById("NotificationIcon").addEventListener("mouseenter", () => {
                  document.getElementById("NotificationIcon").colors = "primary:#252525";
                });
                document.getElementById("NotificationIcon").addEventListener("mouseleave", () => {
