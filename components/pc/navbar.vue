    ...
    <div class="D_LeftHeader">
      <div class="D_ContentHeader">
        <div class="D_AvatarHeader" @click="OpenProfileModal">
          <img
            :src="myuser.profile ? myuser.profile : default_profile"
            alt=""
          />
        </div>
        <div class="D_IconsHeader">
          <!-- <nuxt-link to="/UserSetting">
...
export default {
  ...
  methods: {
    ...
    OpenProfileModal() {
      document
        .getElementById('D_ProfileModal')
        .classList.toggle('ActiveProfileModal')
    },
