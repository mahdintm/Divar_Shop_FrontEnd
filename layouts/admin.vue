        ...
        <div class="D_AdminBox">
          ...
          <div class="AdvertisingInfoBox">
            <div class="AdvertisingInfoSubBox">
              <span>{{ Active }}</span
              ><br /><span>آگهی های فعال</span>
            </div>
            <div></div>
            <div class="AdvertisingInfoSubBox">
              <span>{{ notActive }}</span
              ><br /><span>آگهی های غیرفعال</span>
            </div>
          </div>
          <div class="AdminBoxDetails">
            ...
            <nuxtLink to="/admin/allads">
              <div class="AdminBoxSubDetails">
                ...
                <span
                  >تعداد {{ products.length }} آگهی فعال و غیرفعال موجود
                  میباشد.</span
                >
                <div>مشاهده</div>
              </div>
            </nuxtLink>
            <nuxtLink to="/admin/allUsers">
            <div class="AdminBoxSubDetails">
              <span> اکانت ها:</span>
              <span>تعداد {{ Users.length }} یوزر در دیتابیس فعال میباشد.</span>
              <div>مشاهده</div>
            </div>
            </nuxtLink>
            <!-- <div class="AdminBoxSubDetails">
